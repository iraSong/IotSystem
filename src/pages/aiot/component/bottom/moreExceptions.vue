  ...
  <div class="qdDialog flex-center" @click.self="hide" v-show="showMoreExceptions">
    <div class="dialog-main">
      ...
      <div class="dialog-content">
        ...
        <div class="right">
          <div class="sub-title"><i class="icon" /> 重点关注记录</div>
          <div class="wrap-head">
          ...
          <div class="record-list">
            <div class="table-list">
              <div v-for="(it,idx) in listRecord" :key="idx" @click="changeCurrentItem(it,idx)" :class="[{'active': idx == currentIdx}, 'col-table']">
                ...
                <div class="mark">{{it.personLabel}}</div>
  ...
  methods: {
    ...
    getData() {
      this.$http({
        ...
        .then((res) => {
          let lableNameList = ['访客<br/>通行', '特殊人<br/>员通行', '特殊位<br/>置通行','敏感时<br/>段通行','连续多天<br/>未通行']
          this.list = res.data.passingMonitorStatistic.map((el,idx) => {
            el.lableName = lableNameList[idx]
            return el
          })
