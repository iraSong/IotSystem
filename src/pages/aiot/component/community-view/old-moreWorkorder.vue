    ...
    <div class="main">
      ...
      <div class="right">
        ...
        <div class="item">
          ...
          <div class="content">工单生成:<br />  08:52:10</div>
        </div>
        <div class="item">
          <div class="lable"><span></span></div>
          <div class="content">催办:<br />  08:32:51</div>
        </div>
        ...
        <div class="item">
          <div class="lable"><span></span></div>
          <div class="content">处理完成:<br /> 07:32:39</div>
        </div>
        <div class="item">
          <div class="lable"><span></span></div>
          <div class="content">设备上报:<br /> 06:42:17</div>
        </div>
      </div>
    </div>
  </div>
