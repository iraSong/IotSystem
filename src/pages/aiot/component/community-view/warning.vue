          ...
          <table ref="scorllTable">
            <tbody>
              <tr v-for="(it, idx) in list" :key="idx">
                ...
                <td class="location" :title="it.location">{{it.location}}</td>
...
export default {
  ...
  methods: {
      ...
      let option = {
        ...
        series: [{
            ...
            data: [
              ...
              { 
                value: this.chartData[0].dealing,
                name: '处理中',
                itemStyle: {
                  borderColor: "#00B7FF",
                  borderWidth: 3,
    ...
    initScorll() {
      ...
      console.log(speed)
      function scrollTop() {
        let t = sTab.offsetTop//获取要滚动表的位置
    ...
    getData() {
      ...
      this.$http({
        ...
        .then((res) => {
          this.list = res.data.ufoDeviceAlarmRecordList.slice(0,10)
